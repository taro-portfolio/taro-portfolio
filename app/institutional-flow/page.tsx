...
export default function InstitutionalFlowPage() {
  ...
  return (
    <>
      {/* Navbar แบบกำหนดเองสำหรับหน้า VIP โดยไม่แสดงปุ่ม Login/Get Started เกินความจำเป็น */}
      <nav className="w-full bg-slate-900 border-b border-slate-800 py-3 px-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <span className="text-xl font-black text-white tracking-wider">TARO <span className="text-indigo-400 text-xs px-2 py-0.5 rounded bg-indigo-500/20 border border-indigo-500/30">VIP PORTAL</span></span>
        </div>
        <div className="flex items-center gap-4">
          ...
          <button 
            ...
            className="text-xs font-bold text-rose-400 hover:text-rose-300 bg-rose-500/10 px-3 py-1.5 rounded-lg border border-rose-500/20 transition"
          >
            ออกจากระบบ
          </button>
        </div>
